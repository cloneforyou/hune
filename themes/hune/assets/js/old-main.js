...
$('.header__logo, .cs, .playing').css('background-color', randColor);
...
$('.share-icon').click(function() {
    ...
    $(this).closest('.share-box').find('.link-title,.btm, #btn-play-pause').hide();
...
$('.link-title,.btm, #btn-play-pause').show();
});
